function positionReport(vessel){
    let popupText = "MMSI: "+vessel.MMSI+"<br>"
                +"Location: "+vessel.lat.toFixed(4)+" N, "+vessel.lon.toFixed(4)+" E<br>"
                +"Navigational status: "+vessel.navStatus+"<br>"
                +"Speed over ground: "+vessel.SOG+" knots<br>"
                +"Heading: "+vessel.HDG+"°<br>"
                +"Rate of Turn: "+vessel.ROT+"°/min<br>"
                +"Course over ground: "+vessel.COG+"°<br>"
...
function baseStationReport(vessel){
    let popupText = "<b><u>Base Station</u></b><br> MMSI: "+vessel.MMSI+"<br>"
                +"Location: "+vessel.lat.toFixed(4)+" N, "+vessel.lon.toFixed(4)+" E<br>"
                +"Time Received: "+new Date(vessel.timeReceived).toUTCString();
...
function AidToNavigation(vessel){
    let popupText=  "Name: "+vessel.name+"<br>"
                    +"Aid Type: "+vessel.aidType+"<br>"
                    +"MMSI: "+vessel.MMSI+"<br>"
                    +"Location: "+vessel.lat.toFixed(4)+" N, "+vessel.lon.toFixed(4)+" E<br>"
                    +"Time Received: "+new Date(vessel.timeReceived).toUTCString();
...
function weatherReport(vessel){
    let popupText=  "Name: "+vessel.stationName+"<br>"
                    + "MMSI: "+vessel.MMSI+"<br>"
                    + "Location: "+vessel.lat.toFixed(4)+" N, "+vessel.lon.toFixed(4)+" E<br>"
                    + "Air temperature: "+vessel.temperature+" °C<br>"
                    + "10-min avg wind speed: "+vessel.wspeed+" knots <br>"
